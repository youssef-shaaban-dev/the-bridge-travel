...
import { Mail, Phone, MapPin, Facebook, ChevronRight } from "lucide-react";
    ...
    <footer className="bg-[#22455C] text-white pt-16 pb-8 font-playfair">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              Explore Egypt with The Bridge Travel with luxury Egypt tours, Nile
              cruises, Red Sea holidays, and unforgettable experiences in Cairo,
          ...
          {/* Destinations */}
          <div>
            <h3 className="text-[#BC8B22] text-xl font-bold mb-5">
              Egypt Tours
            </h3>
            <ul className="space-y-2.5">
              <FooterLink
                text="Egypt Tour Packages"
        ...
        <div className="mt-8 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-center items-center gap-6 text-md text-slate-400 font-medium">
          <p>
            © 2026 The Bridge Travel - All content is copyrighted. Unauthorized
            use, including AI training, reproduction, or commercial
            exploitation, is strictly prohibited. Check our{" "}
            <Link
              to="/privacy-policy"
              className="text-[#BC8B22] hover:underline"
            >
              privacy policy.
            </Link>
          </p>
...
const FooterLink = ({ text, to = "#" }) => (
  <li>
    <Link to={to} className="flex items-center gap-2 group cursor-pointer">
      ...
      <span className="text-slate-300 group-hover:text-[#BC8B22] transition-colors text-sm">
        {text}
      </span>
    </Link>
  </li>
...
const SocialIcon = ({ icon }) => (
  <Link
    to="https://www.facebook.com/theBridgeTravelegypt"
    target="_blank"
    className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center text-slate-300 hover:bg-[#BC8B22] hover:text-white hover:border-[#BC8B22] transition-all"
  >
    {icon}
  </Link>
);
  ...
  <div className="bg-white/5 backdrop-blur-sm rounded-[32px] p-6 mb-12 flex flex-wrap items-center justify-between gap-8 border border-white/10">
    <div className="flex items-center gap-4">
      ...
      <div className="flex flex-col">
        <span className="text-slate-400 text-xs uppercase tracking-widest font-bold mb-0.5">
          Location
        </span>
    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-sm font-medium text-slate-200">
          +20 122 77 22233 / +20 100 56 47138
        </span>
      </div>
    </div>
