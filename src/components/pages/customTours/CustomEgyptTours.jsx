                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5">
                                ...
                                <div className="lg:col-span-2 bg-[#22455C] p-10 text-white relative flex flex-col justify-between overflow-hidden">
                                    ...
                                    <div className="relative">
                                        ...
                                        <h2 className="text-3xl font-black mb-6 font-playfair leading-tight">Why a Custom Tour?</h2>
                                    ...
                                    <div className="relative mt-12 pt-8 border-t border-white/10">
                                        <p className="text-white/60 text-sm leading-relaxed mb-4">
                                            "Our experts will respond with a preliminary plan within 24 hours."
                                        </p>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="font-bold text-[#BC8B22]">Get a Free Quote</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="lg:col-span-3 p-10">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-xs font-black text-[#22455C]/60 uppercase tracking-widest">Tell us about your requirements</label>
                                            <div className="relative group">
